...
if (isset($_POST['submit_btn'])) {
  ...
  if($_POST['division']==0) $div = 'Chitradurga';
  else if($_POST['division']==1) $div = 'Dvangere';
  else if($_POST['division']==2) $div = 'Bengaluru';
  else if($_POST['division']==3) $div = 'Mysore';
  else if($_POST['division']==4) $div = 'Hiriyuru';
  else if($_POST['division']==5) $div = 'Shivamogga';
  else $div = 'Holalkere';
